...
import { FieldNameView } from "./FieldNameView";
...
export const FieldForm: React.FC<FormFieldProps> = ({
  ...
  const validTypes: string[] = isRoot
    ? ["Document", "Object"]
    : choosableObjectNames;
          ...
          <>
            ...
            <br />
            {
              ...
              getValues().internalConfig?.predefined && (
                <PreDefinedStringsForm control={control} />
              )
            }
            <br />
          </>
    ...
    return (
      <Accordion>
        <AccordionSummary expandIcon={<FaChevronDown />}>
          ...
          <Typography>
            {getValues().title || (isRoot ? "Schema Editor" : "New Field")}{" "}
            {getValues().name && (
              <FieldNameView>({getValues().name})</FieldNameView>
            )}
            {formState.isDirty ? "*" : ""}
          </Typography>
        </AccordionSummary>
