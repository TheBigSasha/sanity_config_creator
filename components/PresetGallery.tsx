import { Dialog, DialogTitle, DialogContent, DialogContentText, List, ListItem, ListItemIcon, ListItemText, ListItemSecondaryAction, DialogActions, Button } from "@mui/material";
...
export const PresetGallery = ({
    ...
    const [highlightedPreset, setHighlightedPreset] = useState<GalleryPreset | undefined>(undefined);
