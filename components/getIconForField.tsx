...
import { SanityArrayFieldProperties, SanityFieldProperties } from "../types/SanityFieldProperties";
import { BsCalendarDate, BsCardImage } from "react-icons/bs";
import { VscSymbolKeyword, VscSymbolArray, VscSymbolBoolean, VscSymbolFile, VscLocation, VscSymbolNumeric, VscPackage, VscReferences, VscKey, VscSymbolString, VscListTree, VscNote, VscLink, VscSymbolMethod } from "react-icons/vsc";
import { HiOutlineDocumentText } from "react-icons/hi";

export const getIconForField = (field: SanityFieldProperties | string): React.ReactNode => {
