import { SanityDocumentFieldProperties, SanityFieldProperties, SanityObjectFieldProperties } from "../types/SanityFieldProperties";
...
export const hasFields: (typeClass: SanityFieldProperties) => boolean = (typeClass) => {
